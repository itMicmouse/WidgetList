package com.lib_recycleview.layoutmanager;
 ...
 */
public class MineLayoutManager extends RecyclerView.LayoutManager {
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        System.out.println(" childView count:" + getChildCount());
        return travel;
    }
