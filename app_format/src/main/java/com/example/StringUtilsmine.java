...
public class StringUtilsmine {
    ...
    public static boolean isNotEmpty(CharSequence cs) {
        return !StringUtilsmine.isEmpty(cs);
    }
    ...
    public static boolean isNotBlank(CharSequence cs) {
        return !StringUtilsmine.isBlank(cs);
    }
     ...
     * @deprecated This feature will be removed in Lang 4.0, use {@link (String, String)} instead
     */
    @Deprecated
    ...
    public static String swapCase(String str) {
        if (StringUtilsmine.isEmpty(str)) {
            return str;
        }
    ...
    public static <T extends CharSequence> T defaultIfBlank(T str, T defaultStr) {
        return StringUtilsmine.isBlank(str) ? defaultStr : str;
    }
    ...
    public static <T extends CharSequence> T defaultIfEmpty(T str, T defaultStr) {
        return StringUtilsmine.isEmpty(str) ? defaultStr : str;
    }
