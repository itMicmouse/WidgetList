...
public class Location_Activity extends CheckPermissionsActivity
	...
	private void initView(){
		...
		cbOnceLocation.setOnCheckedChangeListener(this);
	}
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		...
		if(buttonView.getId()==R.id.cb_needAddress ){
			if(null != locationOption){
				locationOption.setNeedAddress(isChecked);
			}
		}else if(buttonView.getId()==R.id.cb_cacheAble){
			if(null != locationOption){
				locationOption.setLocationCacheEnable(isChecked);
			}
		}else if(buttonView.getId()==R.id.cb_onceLocation){
			if(null != locationOption){
				locationOption.setOnceLocation(isChecked);
			}
		}
