...
public class BGAFlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /**
         * 1.EXACTLY:100dp,match_parent 2.AT_MOST:wrap_content
    ...
    private boolean isfastadd = true;
    private int original;// 布局文件中的个数

    public void addView4original(View child, LayoutParams params) {
        if (isfastadd) {
            original = getChildCount();
            isfastadd = false;
        }
        addView(child, getChildCount() - original, params);
    }

    public void addView4original(View child) {
        LayoutParams params = new ViewGroup.MarginLayoutParams(ViewGroup.MarginLayoutParams.WRAP_CONTENT, ViewGroup.MarginLayoutParams.WRAP_CONTENT);
        addView4original(child, params);
    }
}